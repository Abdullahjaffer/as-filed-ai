...
- [x] **Filings search + in-app document view**
  ...
  - UI: filters → results grid with a toolbar (Compare two selected filings, Create matrix) → document screen
- [x] **Section matrix**
...
- [x] Document view and side-by-side compare are their own screens (not a drawer)
